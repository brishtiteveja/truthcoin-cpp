...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CHivemindAddress demoAddress = CHivemindAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CHivemindAddress setaccountDemoAddress = CHivemindAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CHivemindAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CHivemindAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
