...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Hivemind Core hivemind-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hivemind-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hivemind transaction") + "\n" +
              "  hivemind-tx [options] -create [commands]   " + _("Create hex-encoded hivemind transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hivemind transaction
