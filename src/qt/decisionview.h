...
#ifndef HIVEMIND_QT_DECISIONVIEW_H
#define HIVEMIND_QT_DECISIONVIEW_H
...
#define DECISIONBRANCH_NLABLES     15
#define DECISIONDECISION_NLABLES   10
...
public:
    explicit DecisionView(QWidget *parent = 0);
...
private:
    ...
    QLabel branchTabLabels[DECISIONBRANCH_NLABLES];

    DecisionDecisionWindow *decisionWindow;
    const marketDecision *decision; 
    QLabel decisionTabLabels[DECISIONDECISION_NLABLES];

    DecisionMarketWindow *marketWindow;
    const marketMarket *market; 
    QLabel marketTabLabels[DECISIONMARKET_NLABLES];

    DecisionTradeWindow *tradeWindow;
    const marketTrade *trade; 
    QLabel tradeTabLabels[DECISIONTRADE_NLABLES];
...
#endif // HIVEMIND_QT_DECISIONVIEW_H
