...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/hivemind"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hivemind Core"),
     ...
     * override -datadir in the hivemind.conf file in the default data directory
     * (to be consistent with hivemindd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
