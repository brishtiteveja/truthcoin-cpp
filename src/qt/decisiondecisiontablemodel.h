...
#ifndef HIVEMIND_QT_DECISIONDECISIONTABLEMODEL_H
#define HIVEMIND_QT_DECISIONDECISIONTABLEMODEL_H
...
public:
    explicit DecisionDecisionTableModel(CWallet *, WalletModel * = 0);
    ~DecisionDecisionTableModel();
...
private:
    ...
    QStringList columns;
    DecisionDecisionTablePriv *priv;

public slots:
    friend class DecisionDecisionTablePriv;
};
...
#endif // HIVEMIND_QT_DECISIONDECISIONTABLEMODEL_H
