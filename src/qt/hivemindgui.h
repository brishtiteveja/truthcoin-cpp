...
#ifndef HIVEMIND_QT_HIVEMINDGUI_H
#define HIVEMIND_QT_HIVEMINDGUI_H
...
/**
  Hivemind GUI main class. This class represents the main window of the Hivemind UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HivemindGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HivemindGUI(const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~HivemindGUI();
...
#endif // HIVEMIND_QT_HIVEMINDGUI_H
