...
#ifndef HIVEMIND_QT_HIVEMINDUNITS_H
#define HIVEMIND_QT_HIVEMINDUNITS_H
...
/** Hivemind unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HivemindUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HivemindUnits(QObject *parent);

    /** Hivemind units.
      @note Source: https://en.hivemind.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef HivemindUnits::Unit HivemindUnit;

#endif // HIVEMIND_QT_HIVEMINDUNITS_H
