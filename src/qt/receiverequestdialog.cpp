...
#include "config/hivemind-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHivemindURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HivemindUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHivemindURI(info));
}
