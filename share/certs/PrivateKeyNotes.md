...
unlocked to sign the Hivemind-Qt.app bundle.
...
allowing somebody to distribute a Hivemind-Qt.app or hivemind-qt-setup.exe with a valid
...
that the hivemind-qt.exe file inside the installer had not been tampered with.
