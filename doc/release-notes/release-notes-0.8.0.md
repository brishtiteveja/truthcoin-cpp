Hivemind-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hivemind/files/Hivemind/hivemind-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hivemind
...
New/changed settings (command-line or hivemind.conf file)
--------------------------------------------------------
