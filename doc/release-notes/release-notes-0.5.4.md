Hivemind version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hivemind/files/Hivemind/hivemind-0.5.4/
...
http://gitorious.org/hivemind/hivemindd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hivemind-Qt notifications under Growl 1.3.
Increase required age of Hivemind-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHivemind properly when installing Hivemind-Qt over it. (Windows)
