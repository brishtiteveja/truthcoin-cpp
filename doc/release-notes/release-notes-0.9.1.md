Hivemind Core version 0.9.1 is now available from:

  https://hivemind.org/bin/0.9.1/
...
hivemindd from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Hivemind Core software:
