The following is a list of assets used in the hivemind source and their proper attribution.
...
* Hivemind Icon: (based on the original hivemind logo from Bitboy)
...
### Assets Used
    ...
    src/qt/res/icons/hivemind.icns, src/qt/res/icons/hivemind.ico,
    src/qt/res/icons/hivemind.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/hivemind.svg,
